    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-8">
        <div class="p-6 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
            <h3 class="font-bold text-gray-800 flex items-center gap-2 capitalize">
                <i class="ri-money-dollar-circle-line text-[#cb5c55]"></i> {{ $filter }} Revenue Breakdown
            </h3>
        </div>
                        ...
                        <tr class="group hover:bg-gray-50 transition">
                            ...
                            <td class="py-4 w-1/2">
                                <div class="h-3 bg-gray-100 rounded-full overflow-hidden flex">
                                    <div class="h-full bg-[#cb5c55] transition-all duration-1000 ease-out" style="width: {{ min(100, ($amount / 5000) * 100) }}%"></div>
                                </div>
                            </td>
                            <td class="py-4 text-right pr-4 font-bold text-[#cb5c55] w-1/4">RM {{ number_format($amount, 2) }}</td>
                        </tr>
                        @endforeach
                    </tbody>
