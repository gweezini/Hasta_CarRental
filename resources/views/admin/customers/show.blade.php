...
<head>
    ...
    <title>Customer Profile - Hasta Admin</title>
...
<body class="flex h-screen overflow-hidden">
    ...
    <main class="flex-1 overflow-y-auto p-8 bg-[#f3f4f6]" x-data="{ showBlacklistModal: false }">
        
        <div class="mb-6">
            <a href="{{ route('admin.customers.index') }}" class="inline-flex items-center text-gray-500 hover:text-[#cb5c55] transition text-sm font-bold">
