    ...
    <div class="min-h-screen flex">
        <aside class="w-64 bg-[#cb5c55] text-white flex flex-col fixed h-full shadow-lg z-50">
            ...
            <nav class="flex-1 p-4 space-y-2">
                <a href="#" class="block py-3 px-4 rounded bg-white/20 text-white font-medium shadow-inner">
                    <i class="ri-dashboard-line mr-2"></i> Dashboard
                </a>

                <a href="{{ route('admin.vehicle.index') }}" class="block py-3 px-4 rounded hover:bg-white/10 text-white hover:text-white transition">
