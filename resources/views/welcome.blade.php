...
<html lang="en">
  ...
  * {
  ...
  header {
    position: relative;
    /* Using Blade asset helper for correct path */
  ...
  @media (max-width: 1024px) {
    .range__card { flex: 0 1 calc(50% - 2rem); /* 2 cards per row on tablet */ }
  }
  ...
  @media (max-width: 768px) {
    ...
    .header__container h1 { font-size: 2.5rem; }
    .header__container form { grid-template-columns: 1fr; }
    .range__card { flex: 0 1 100%; /* 1 card per row on mobile */ }
    .footer__container { grid-template-columns: repeat(2, 1fr); }
    .header__container form .btn { grid-column: 1; }
    .checkbox_group, .dropoff_group { grid-column: 1; }
  }
</style>
